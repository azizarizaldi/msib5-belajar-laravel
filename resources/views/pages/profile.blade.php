        ...
        <div class="col-lg-4">
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-1">Full Stack Developer - GITS.ID</p>
                    <p class="text-muted mb-4">Studi Independen Batch 5</p>
                    <div class="d-flex justify-content-center mb-2">
                        <a href="https://api.whatsapp.com/send?phone=6285155336568&text=Hai%20Aziz" target="_blank" type="button" class="btn btn-success ms-1" >
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush rounded-3">
                        <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                            ...
                            <p class="mb-0"><a href="https://github.com/azizarizaldi" class='text-decoration-none' target="_blank">@azizarizaldi</a></p>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                            <i class="fab fa-twitter fa-lg" style="color: #55acee;"></i>
                            <p class="mb-0"><a href="https://twitter.com/azizarizaldi" class='text-decoration-none' target="_blank">@azizarizaldi</a></p>
                        </li>
                    </ul>
                </div>
            </div>
